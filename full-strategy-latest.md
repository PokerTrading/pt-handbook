...
> **本章要点速记**
>
> 甜点位 = RE三层（结构锚点>K线开盘价>Fib） · AC三层（突破位回踩>POC翻转>Fib） · Fib比例：默认0.618，信号强+距离远+穿HVN→0.5，信号弱或穿LVN→0.786，附近有结构位优先用结构 · 多个候选：信号强选近的，路上HVN选前方，LVN别选中间 · 够不到（VA外）或未成交→弃牌不追价 · 挂限价单 · 有效期=验牌通过起§6.1表格 · 提前失效：否定/反向AC通过验牌/桌风对立
>
