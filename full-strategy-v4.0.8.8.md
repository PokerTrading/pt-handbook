# Poker Trading Handbook · v4.0.8.8

编译时间：2026-02-15 23:46 UTC
...
**AA（有共振+信号强）：** 执行桌边界和更高周期关键位重合，Radar评分7+。两个维度都到位=最强牌力，标准仓位入场。

【截图：AA——有共振+信号强(7+)】

**KK（有共振+信号不强）：** 执行桌边界和更高周期关键位重合，但Radar评分4-6。共振给了方向信心，信号力度一般。

【截图：KK——有共振+信号不强(4-6)】

**AK（无共振+信号强）：** 执行桌边界没有更高周期关键位配合，但Radar评分7+。信号力度够，缺少跨周期确认。

【截图：AK——无共振+信号强(7+)】

**AQ（无共振+信号不强）：** 执行桌边界没有共振，Radar评分4-6。两个维度都不突出=最低门槛，只在顺风时轻仓。
