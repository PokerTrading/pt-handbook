# Poker Trading Handbook · v4.0.6.3

编译时间：2026-02-15 02:12 UTC
...
【截图：第一组——黄金现货30分钟图（Poker Table），5天日VP并排显示。每张VP清晰标注：VAH ▶ / VAL ▶（价值区上下界虚线）、POC ▶（控制点）。红色块=HVN（高成交密集区）、绿色块=LVN（低成交通道）。同时可见Excess High和Excess Low标记、Poor High标记。VA随天数逐步上移，展示价值区迁移过程】
