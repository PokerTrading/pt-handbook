# Poker Trading Handbook · v4.1.0.0

编译时间：2026-02-16 02:49 UTC
...
![Poker Flow界面：黄金现货5分钟图，两个分时段VP并排显示（Tokyo→London），底部Poker Flow数值15.432，箭头标注Table Flow切换时段的过程](images/ch2-poker-flow.png)
...
**Excess事件：** Excess成型后价格有没有快速远离Excess区域？判断标准和RE相同（根数少+距离远+实体实）。
...
**Excess后的能量 = 同向Radar信号出现。** 如Excess High成型后出现dRE或dAC，方向一致即算能量确认。
...
| **① 第一关** | 方向：有没有反弹 | 评分：7+→直接过 | 跳过（无Radar评分） |
| **② 响应速度** | 2-3根K线内连贯远离+实体为主→直接过 | （评分不到7+才到这步，直接看③④）| 快速远离Excess区域→直接过 |
| **③ 持续确认** | 停留在新方向，越久越好 | 站稳在突破位上方 | 停留在远离Excess方向 |
| **④ 能量** | 同向AC出现（RE+AC配合） | 连续AC推进（AC+AC连续） | 同向Radar信号出现 |
| **失败标志** | 没反弹 / 回到拒绝位 | 回到突破位内侧 | 价格回到Excess区域内 |
...
**Excess发牌：** 没有Radar评分，单Excess默认按🟡B档处理（耐心观察②响应速度），双Excess按🟢A档。
...
>
> Excess验牌：跳过①→②快速远离?→③停留 / ④同向Radar信号 · 无评分默认B档 · 双Excess按A档
>
...
| VAL / IBL | 假跌破（AC失败→反弹） | 在支撑位做多 | 顺风诈唬牌 | ⭐⭐⭐ |
| VAH / IBH | 真突破（AC成功+验牌） | 回踩突破位做多 | 顺风牌 | ⭐⭐ |
| VAH / IBH / PH / Excess High | 拒绝打回（RE / Excess） | 在阻力位卖贵做空 | 逆风牌 | ⭐ 逆风 |
| VAH / IBH | 假突破（AC失败→回落） | 在阻力位做空 | 逆风诈唬牌 | ⭐ 逆风 |
| VAL / IBL | 真跌破（AC成功+验牌） | 反弹至跌破位做空 | 逆风牌 | ⭐ 逆风 |
...
| VAH / IBH | 假突破（AC失败→回落） | 在阻力位做空 | 顺风诈唬牌 | ⭐⭐⭐ |
| VAL / IBL | 真跌破（AC成功+验牌） | 反弹至跌破位做空 | 顺风牌 | ⭐⭐ |
| VAL / IBL / PL / Excess Low | 拒绝弹回（RE / Excess） | 在支撑位买便宜做多 | 逆风牌 | ⭐ 逆风 |
| VAL / IBL | 假跌破（AC失败→反弹） | 在支撑位做多 | 逆风诈唬牌 | ⭐ 逆风 |
| VAH / IBH | 真突破（AC成功+验牌） | 回踩突破位做多 | 逆风牌 | ⭐ 逆风 |
...
以上6种牌型全部以多头桌风为例。空头桌风下完全对称：上方边界RE打回做空=顺风牌，下方边界RE弹回做多=逆风牌，以此类推。判断方法永远一样——先看你的交易方向，再和桌风比，同向=顺风，反向=逆风。
...
**KK（有共振+信号不强+顺风）：** 执行桌边界和更高周期关键位重合，但Radar评分4-6，交易方向顺桌风。共振给了方向信心，信号力度一般，9手入场。逆风时KK需满足三条件（7+ + 纹理不湿润 + R:R≥2:1）才入池。
...
| **逆风牌** | 🟡 降级入池 · 9手(KK) | 🟡 条件入池 · 6手(AK) · *需三条件 | 🟡 降级入池 · 3手(AQ) | 🔴 弃牌 |
| **逆风诈唬牌** | 🟡 降级入池 · 9手(KK) | 🟡 条件入池 · 6手(AK) · *需三条件 | 🟡 降级入池 · 3手(AQ) | 🔴 弃牌 |
| **中性牌（平衡桌风）** | 🟢 标准入池 · 12手 | 🟡 轻仓入池 · 6手 | 🔴 多数弃牌（仅7+时轻仓） | 🔴 弃牌 |
...
- R:R硬要求提高0.5（顺风牌≥2.0:1，中性牌≥2.3:1，逆风牌≥2.5:1）
...
逆风牌要求更高是因为逆风方向胜率更低——需要更大的盈利空间来弥补。中性牌（平衡桌风）介于两者之间。
...
☐ R:R ≥ 门槛（顺风1.5 / 中性1.8 / 逆风2.0 / 数学SL+0.5）
...
短线桌做多黄金，dRE@VAL，Radar 7.5。甜点位=VAL $2,648（结构锚点🥇）。SL方向往下看：PL在$2,638。SL画在PL外侧=$2,636。SL距离=$12。TP1=路上第一个HVN边缘$2,665。R:R=($2,665-$2,648)÷($2,648-$2,636)=17÷12=1.42:1。顺风牌R:R门槛1.5:1——不达标。**弃牌。**
...
>
> R:R门槛：顺风≥1.5 · 中性≥1.8 · 逆风≥2.0 · 数学SL再+0.5 · 不达标→弃牌
>
...
举个例子：账户$10,000，风险百分比2%（AA级），允许的最大风险=$200。做多黄金，SL距离$10，黄金每手$1/点。每手风险=$10。$200÷$10=20手。但AA上限是12手，所以用12手入场，实际风险=$120=1.2%账户。

> "每点价值"取决于你的交易平台和合约规格——入场前先确认：在你的平台上，1手(lot)的每$1价格变动对应多少美元盈亏。

另一个例子：账户$5,000，风险百分比0.5%（AQ级），允许的最大风险=$25。做多BTC，SL距离$500，每手$0.01/点。每手风险=$5。$25÷$5=5手。AQ上限3手，用3手，实际风险=$15=0.3%账户。
...
AA到AQ之间有4倍的仓位差距。最强的牌用最多的钱，最弱的牌用最少的钱——让好机会赚更多，差机会即使做错也亏得少。分仓均分三组（安全组/价值组/贪婪组），每组手数=总手数÷3。

### 多重降级来源的仓位调整

Ch5提到降级不叠加、取最严格的那个。但如果你有多个降级来源同时存在（比如桌风分歧+纹理湿润），虽然牌力只降一级，仓位要额外减半。牌力决定"打不打"，仓位反映"多重不利因素叠加的风险"。

例：原始牌力AA，桌风分歧降到KK，同时纹理湿润——牌力按KK打，手数=9×50%=4.5→取整4手。

### 信号评分微调

同一牌力档位内，评分更高的信号可以接近满仓，评分只是勉强过线的可以偏轻。AA级中Radar 9.8用12手，Radar 7.1用9手。这是进阶调整，新手按牌力直接对应手数就行。
...
初始轻仓入场，后面等结构事件出现后加注。适合大级别的顺风牌——先用小仓位试水，市场证明你对了再加码。
...
适用场景：大级别牌力（AA/KK）+ 顺风 + 干燥纹理 + 路上有明确的结构事件可以作为加注触发点。
...
| 组别 | 默认占比 | 使命 | 平仓触发 |
|------|---------|------|---------|
| **安全组** | 1/3 | TP1到了就走——锁定R:R计算基础，保证这手牌不白打 | TP1达成 |
| **价值组** | 1/3 | 吃行情主体——跟到TP2区域，收割主要利润 | TP2达成 |
| **贪婪组** | 1/3 | 博大行情——不急着走，等TP3、结构反转信号或对侧Excess成型 | TP3/结构反转/对侧Excess |
...
**迷你四街走势：** 你做多黄金，前置12手入场@$2,648，SL@$2,636，TP1@$2,665。价格涨到$2,665——TP1到了，安全组（4手）平仓赚$68，价值组+贪婪组SL移到$2,648（入场价）。继续持有。价格推到$2,680（TP2），价值组（4手）平仓赚$128。贪婪组（4手）SL移到$2,665（TP1）。价格到$2,695附近出现对侧Excess成型信号，贪婪组4手全平，赚$188。总盈利$68+$128+$188=$384。全程SL只往有利方向移动，从不后退。
...
>
> 前置=一次入场 · 分街=轻仓+两次加注（各走验牌） · 逆风/延续/中性/新手→前置 · AA/KK顺风干燥→分街
>
> 安全组1/3(TP1平仓)+价值组1/3(TP2平仓)+贪婪组1/3(TP3/反转/Excess下桌) · SL管理：TP前不碰→TP1后移入场价→TP2后移TP1
>
...
**熔断日记：** 周二下午连续止损3次，日亏达到2.1%。日熔断触发。关闭交易软件，去跑了5公里。回来后复盘三笔——发现都是合规入场，但当天市场进入洗牌期，信号K线质量普遍下降。结论：不是你做错了，是市场暂时不适合做。周三早上带着清醒的头脑重新评估，发现桌风重新清晰，下午捕到一笔AA级顺风牌——$180。熔断不是惩罚，是保护。
...
AA=12手。前置下注（顺风AA虽然也可以分街，但甜点位精确、信号清晰，前置即可）。黄金每手$1/点。

安全组4手 / 价值组4手 / 贪婪组4手。

在$2,648挂限价多单12手，SL挂$2,634，TP1挂$2,670（安全组4手）。等成交。

### 第八步：四街管理（Ch7）

**翻牌前：** 限价单成交于$2,648。12手全部入场。SL和TP1已挂好。

**翻牌（TP1）：** 价格推到$2,670，安全组4手平仓。盈利=($2,670-$2,648)×4=$88。价值组+贪婪组SL从$2,634移到入场价$2,648（保本）。

**转牌（TP2）：** 价格继续推到$2,685，价值组4手平仓。盈利=($2,685-$2,648)×4=$148。贪婪组4手SL移到TP1=$2,670。

**河牌（TP3）：** 价格推到$2,705附近出现结构反转信号（uRE@偏见桌关键位）。贪婪组下桌，4手平仓于$2,705。盈利=($2,705-$2,648)×4=$228。

**总盈利：$88+$148+$228=$464。** 风险$168（12手×$14 SL），收益$464。实际R:R=2.8:1。
...
SL太小。换结构位？上方没有更远的结构位了（PH就是最高的）。数学SL？KK+Radar 7.2（7+）满足条件。反推：TP1=$2,678（HVN边缘），潜在盈利$17。数学SL R:R要求=逆风2.0+0.5=2.5:1。SL=$17÷2.5=$6.8。$2,695+$6.8=$2,701.8。仓位从KK(9手)降到AK(6手)。
...
6手前置下注（逆风牌只用前置）。安全组2手 / 价值组2手 / 贪婪组2手。黄金每手$1/点。

入场$2,695，SL挂$2,701.8，TP1挂$2,678（安全组2手）。

**翻牌（TP1）：** 价格回落到$2,678，安全组2手平仓。盈利=($2,695-$2,678)×2=$34。价值组+贪婪组SL移到入场价$2,695（保本）。

**转牌（TP2）：** 价格继续跌到$2,665，价值组2手平仓。盈利=($2,695-$2,665)×2=$60。贪婪组2手SL移到TP1=$2,678。

**河牌：** 价格反弹，贪婪组2手被SL@$2,678扫掉。盈利=($2,695-$2,678)×2=$34。

**总盈利：$34+$60+$34=$128。** 风险$40.8（6手×$6.8数学SL），收益$128。实际R:R=3.1:1。
...
KK=9手。前置下注。安全组3手 / 价值组3手 / 贪婪组3手。BTC每手$1/点。

在$94,200挂限价多单9手，SL挂$93,400，TP1挂$98,500（安全组3手）。

### 第八步：四街管理（Ch7）

**翻牌前：** 限价单成交于$94,200。9手全部入场。

**翻牌（TP1）：** 价格推到$98,500，安全组3手平仓。盈利=($98,500-$94,200)×3=$12,900。价值组+贪婪组SL移到入场价$94,200（保本）。

**转牌（TP2）：** 价格推到$100,800附近出现uRE信号。价值组3手平仓。盈利=($100,800-$94,200)×3=$19,800。贪婪组3手SL移到TP1=$98,500。

**河牌：** 价格回调，贪婪组3手被SL@$98,500扫掉。盈利=($98,500-$94,200)×3=$12,900。

**总盈利：$12,900+$19,800+$12,900=$45,600。** 风险$7,200（9手×$800 SL），收益$45,600。实际R:R=6.3:1。
...
AA=12手。前置下注。安全组4手 / 价值组4手 / 贪婪组4手。

在$3,420挂限价空单12手，SL挂$3,465，TP1挂$3,310（安全组4手）。

### 第八步：四街管理（Ch7）

**翻牌前：** 限价单成交于$3,420。12手全部入场。

**翻牌（TP1）：** 价格推到$3,310，安全组4手平仓。盈利=($3,420-$3,310)×4=$440。价值组+贪婪组SL移到入场价$3,420（保本）。

**转牌（TP2）：** 价格继续跌到$3,235。在$3,220前方出现一根长下影线（买盘反扑迹象）。价值组4手平仓于$3,240。盈利=($3,420-$3,240)×4=$720。贪婪组4手SL移到TP1=$3,310。

**河牌：** 价格反弹，贪婪组4手被SL@$3,310扫掉。盈利=($3,420-$3,310)×4=$440。

**总盈利：$440+$720+$440=$1,600。** 风险$540（12手×$45 SL），收益$1,600。实际R:R=3.0:1。
...
仓位 12手前置 · 安全4/价值4/贪婪4
结果 TP2区域下桌 · +$1,600 · 实际R:R 3.0:1
```
